...
const TEXT = {
  Arabic: {
    ...
    using_default_data: "يتم الآن استخدام الملف الافتراضي لأنك لم ترفعي ملفًا.",
    ...
    not_found_data: "ملف البيانات غير موجود",
  ...
  English: {
    ...
    using_default_data: "Using the default dataset because no file was uploaded.",
    ...
    not_found_data: "Dataset not found",
...
const REQUIRED_COLUMNS = [
  "hours_worked","meetings_per_day","stress_score","sleep_hours",
  "productivity_drop","overtime_hours","workload_level","job_satisfaction"
];

async function loadDefaultData(){
  try{
    const res = await fetch("data/burnout_data.csv");
...
async function renderDashboard(){
  ...
  if(!rowsRaw.length){
    root.innerHTML = showMessage("error", tx.not_found_data);
    return;
  }
  ...
  Plotly.newPlot("chart1", [{
    ...
    textposition:"auto"
  }], {title:tx.chart1_plot_title,paper_bgcolor:"#0A0F1E",plot_bgcolor:"#0A0F1E",font:{color:"white"}}, {displayModeBar:false,responsive:true});
  ...
  }], {title:tx.chart2_plot_title,paper_bgcolor:"#0A0F1E",plot_bgcolor:"#0A0F1E",font:{color:"white"}}, {displayModeBar:false,responsive:true});
  ...
  }], {title:tx.chart3_plot_title,paper_bgcolor:"#0A0F1E",plot_bgcolor:"#0A0F1E",font:{color:"white"}}, {displayModeBar:false,responsive:true});
  ...
  Plotly.newPlot("chart4", [{
    ...
    x: tx.metric_names,
    y: summary
  }], {title:tx.chart4_plot_title,paper_bgcolor:"#0A0F1E",plot_bgcolor:"#0A0F1E",font:{color:"white"}}, {displayModeBar:false,responsive:true});
  ...
  }], {title:tx.risk_map_title,paper_bgcolor:"#0A0F1E",plot_bgcolor:"#0A0F1E",font:{color:"white"}}, {displayModeBar:false,responsive:true});
  ...
  }], {title:tx.heatmap_title,paper_bgcolor:"#0A0F1E",plot_bgcolor:"#0A0F1E",font:{color:"white"}}, {displayModeBar:false,responsive:true});
...
async function renderExecutive(){
  ...
  }], {title:tx.executive_trend_title,paper_bgcolor:"#0A0F1E",font:{color:"white"}}, {displayModeBar:false,responsive:true});
